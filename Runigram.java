...
public class Runigram {
	...
	public static void main(String[] args) {
		...
		Color test = new Color(254,56,103);
		System.out.println(luminance(test).getRed());
		System.out.println(luminance(test).getGreen());
		System.out.println(luminance(test).getBlue());

		Color c1 = new Color(100,40,100);
		Color c2 = new Color(175,25,55);
		System.out.println(blend(c1, c2, 0.25).getRed());
		System.out.println(blend(c1, c2, 0.25).getGreen());
		System.out.println(blend(c1, c2, 0.25).getBlue());
	}
	...
	public static Color[][] flippedVertically(Color[][] image){
		...
		for (int j = 0; j < image[0].length; j++){
			...
			for (int i = image.length - 1; i >= 0 ; i--){
				flippedImage[rowIndex][j] = image[i][j];
				rowIndex++;
			}	
		}
		return flippedImage;
